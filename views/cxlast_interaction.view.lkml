# The name of this view in Looker is "Cxlast Interaction"
view: cxlast_interaction {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dev_kpis.cx-last_interaction`
    ;;
  ...
  dimension: Finalizadas {
    case: {
      when: {
        sql: ${end_conversation} = true ;;
        label: "sessionID"
      }
    }
  }
